 ...
 * This file defines the layout of the 'CONTROL_INSTRUCTION_with_header' message type.
 */
...
enum {
  ...
  /* Field control_instruction: type uint8_t, offset (bits) 64, size (bits) 8 */
  /** Offset (in bytes) of the field 'control_instruction' */
  CMDPACKET_CONTROL_INSTRUCTION_OFFSET = 8,
  /** Offset (in bits) of the field 'control_instruction' */
  CMDPACKET_CONTROL_INSTRUCTION_OFFSETBITS = 64,
  /** Size (in bytes) of the field 'control_instruction' */
  CMDPACKET_CONTROL_INSTRUCTION_SIZE = 1,
  /** Size (in bits) of the field 'control_instruction' */
  CMDPACKET_CONTROL_INSTRUCTION_SIZEBITS = 8,

  /* Field server_nodeID: type uint16_t, offset (bits) 72, size (bits) 16 */
  /** Offset (in bytes) of the field 'server_nodeID' */
  CMDPACKET_SERVER_NODEID_OFFSET = 9,
  /** Offset (in bits) of the field 'server_nodeID' */
  CMDPACKET_SERVER_NODEID_OFFSETBITS = 72,
  ...
  /* Field command_length: type uint8_t, offset (bits) 88, size (bits) 8 */
  /** Offset (in bytes) of the field 'command_length' */
  CMDPACKET_COMMAND_LENGTH_OFFSET = 11,
  /** Offset (in bits) of the field 'command_length' */
  CMDPACKET_COMMAND_LENGTH_OFFSETBITS = 88,
...
/**
 * Return the value of the field 'control_instruction'
 */
uint8_t cmdpacket_control_instruction_get(tmsg_t *msg);

/**
 * Set the value of the field 'control_instruction'
 */
